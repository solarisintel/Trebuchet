...
abstract class BaseFlags {
    ...
    public static final String AUTHORITY = "com.android.launcher3b.settings".intern();

    // When enabled allows to use any point on the fast scrollbar to start dragging.
    public static final boolean launcher3b_DIRECT_SCROLL = true;
    // When enabled the promise icon is visible in all apps while installation an app.
    public static final boolean launcher3b_PROMISE_APPS_IN_ALL_APPS = true;
    // When enabled allows use of spring motions on the icons.
    public static final boolean launcher3b_SPRING_ICONS = true;
